# Queen Mary University of London Arumugam Nallanathan 与 DeepSC 团队：检索策略与筛选记录

## 范围与口径

- 检索截止：2026-07-15；正式出版时间范围：2021-01-01 至 2026-07-15。
- 负责人：Arumugam Nallanathan；OpenAlex author IDs：A5002265731。
...
- OpenAlex 作者全集：{"A5002265731": 447}。
- OpenAlex 扩展查询：{"DeepSC semantic communication": 200, "semantic communication Queen Mary University of London": 200}。
...
- 正式技术论文纳入：26。
- 排除或被期刊版取代：21。
- 年份分布：2021: 5, 2022: 3, 2023: 6, 2024: 7, 2025: 4, 2026: 1。
...
Crossref 与 DBLP 回查发现并经正式 DOI/负责人署名复核后新增 4 篇；Semantic Scholar 搜索端点返回 429，早先 OA 批量核验结果仍保留在下载清单。新增项已进入全文下载和再次筛选，不把初始 OpenAlex 数量当作完成标准。
...
- 候选池：51；核心正式技术论文：22；排除/背景/被取代记录：29。
- 全文：22/22 份已通过 `%PDF`、页数、标题匹配与 SHA-256 校验；合法访问阻塞：无。
- 补充轮次：Crossref: raw 100, topic 13, new formal technical 0; DBLP: raw 14, topic 10, new formal technical 0; Semantic Scholar: raw 2, topic 0, new formal technical 0, error HTTP 429。
