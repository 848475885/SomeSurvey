...
/* Hash links need the real height of every preceding paper; estimated skipped heights drift on repeated clicks. */
.paper{content-visibility:visible;contain-intrinsic-size:none}
"""
