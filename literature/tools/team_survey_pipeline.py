...
/* Reserve image space before lazy-loaded evidence pages arrive, so hash targets stay stable. */
.fig-grid figure img{aspect-ratio:827/1070;object-fit:contain;background:#fff}
"""
