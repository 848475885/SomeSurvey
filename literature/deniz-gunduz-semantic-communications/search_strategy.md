# Imperial College London Deniz Gündüz 团队：检索策略与筛选记录

## 范围与口径

- 检索截止：2026-07-15；正式出版时间范围：2021-01-01 至 2026-07-15。
- 负责人：Deniz Gündüz, Deniz Gunduz, Denız Gündüz；OpenAlex author IDs：A5016883501。
...
- 正式技术论文纳入：40。
- 排除或被期刊版取代：54。
- 年份分布：2022: 11, 2023: 10, 2024: 10, 2025: 7, 2026: 2。
...
Crossref 与 DBLP 回查发现并经正式 DOI/负责人署名复核后新增 3 篇；Semantic Scholar 搜索端点返回 429，早先 OA 批量核验结果仍保留在下载清单。新增项已进入全文下载和再次筛选，不把初始 OpenAlex 数量当作完成标准。
...
- 候选池：100；核心正式技术论文：37；排除/背景/被取代记录：63。
- 全文：37/37 份已通过 `%PDF`、页数、标题匹配与 SHA-256 校验；合法访问阻塞：无。
- 补充轮次：Crossref: raw 100, topic 14, new formal technical 0; DBLP: raw 29, topic 29, new formal technical 0; Semantic Scholar: raw 1, topic 0, new formal technical 0, error HTTP 429。
