# University of Surrey Yi Ma—Mahdi Boloursaz Mashhadi 团队：检索策略与筛选记录

## 范围与口径

- 检索截止：2026-07-15；正式出版时间范围：2021-01-01 至 2026-07-15。
- 负责人：Mahdi Boloursaz Mashhadi, Yi Ma；OpenAlex author IDs：A5028862760, A5124039651。
...
- OpenAlex 作者全集：{"A5028862760": 70, "A5124039651": 4}。
- OpenAlex 扩展查询：{"semantic communication University of Surrey": 200, "token communications Surrey": 200}。
...
Crossref 与 DBLP 回查发现并经正式 DOI/负责人署名复核后新增 5 篇；Semantic Scholar 搜索端点返回 429，早先 OA 批量核验结果仍保留在下载清单。新增项已进入全文下载和再次筛选，不把初始 OpenAlex 数量当作完成标准。
...
- 候选池：30；核心正式技术论文：11；排除/背景/被取代记录：19。
- 全文：11/11 份已通过 `%PDF`、页数、标题匹配与 SHA-256 校验；合法访问阻塞：无。
- 补充轮次：Crossref: raw 200, topic 23, new formal technical 0; DBLP: raw 46, topic 18, new formal technical 0; Semantic Scholar: raw 2, topic 0, new formal technical 0, error HTTP 429。
